...
const main = async () => {
    ...
    //     await uploadFileToBlob(containerServicePublish, tempFilePath, blobName);

    //     const uploadedBlobClient = containerServicePublish.getBlockBlobClient(blobName);
    //     console.log(`Fully qualified URL: ${uploadedBlobClient.url}`);

    //     fs.unlinkSync(tempFilePath);
    //     console.log(`Uploaded page data file with ${pageData.length} entries to blob storage`);
    // }
